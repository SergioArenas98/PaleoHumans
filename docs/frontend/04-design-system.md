...
The backoffice imports Leaflet CSS globally (`angular.json` config) because the admin app may render maps for editorial preview workflows. The public web does not import Leaflet CSS globally — see [01-frontend-architecture.md](./01-frontend-architecture.md).
