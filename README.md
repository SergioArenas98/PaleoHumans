...
Unless otherwise stated, the PaleoHumans dataset is licensed under the Creative Commons Attribution 4.0 International License (CC BY 4.0).

You are free to share and adapt the dataset for any purpose, provided that you give appropriate credit, cite the original article, link to the license, and indicate whether changes were made.
